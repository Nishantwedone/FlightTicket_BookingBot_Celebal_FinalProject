...
const indianCities = {
  ...
  patna: ["PAT", "Patna", "पटना", "Patna", "Patna"],
  bhopal: ["BHO", "Bhopal", "भोपाल", "Bhopal", "Bhopal"],
  jammu: ["IXJ", "Jammu", "जम्मू", "Jammu", "Jammu"],
  shimla: ["SLV", "Shimla", "शिमला", "Shimla", "Shimla"],
  darbhanga: ["DBR", "Darbhanga", "दरभंगा", "Darbhanga", "Darbhanga"],
  madurai: ["IXM", "Madurai", "मदुरै", "Madurai", "Madurai"],
  kanpur: ["KNU", "Kanpur", "कानपुर", "Kanpur", "Kanpur"],
  visakhapatnam: ["VTZ", "Visakhapatnam", "विशाखापत्तनम", "Visakhapatnam", "Visakhapatnam"],
  mangalore: ["IXE", "Mangalore", "मंगलुर", "Mangalore", "Mangalore"],
  tiruchirappalli: ["TRZ", "Tiruchirappalli", "तिरुच्चिरापल्ली", "Tiruchirappalli", "Tiruchirappalli"],
  surat: ["STV", "Surat", "सूरत", "Surat", "Surat"],
  ludhiana: ["LUH", "Ludhiana", "लुधियाना", "Ludhiana", "Ludhiana"],
  varanasi: ["VNS", "Varanasi", "वाराणसी", "Varanasi", "Varanasi"],
  amritsar: ["ATQ", "Amritsar", "अमृतसर", "Amritsar", "Amritsar"],
  udaipur: ["UDR", "Udaipur", "उदयपुर", "Udaipur", "Udaipur"],
  guwahati: ["GAU", "Guwahati", "गुवाहाटी", "Guwahati", "Guwahati"],
  raipur: ["RPR", "Raipur", "रायपुर", "Raipur", "Raipur"],
  ranchi: ["IXR", "Ranchi", "रांची", "Ranchi", "Ranchi"],
  bhuj: ["BHUJ", "Bhuj", "भुज", "Bhuj", "Bhuj"],
  siliguri: ["IXB", "Siliguri", "सिलिगुड़ी", "Siliguri", "Siliguri"],
  hubli: ["HBX", "Hubli", "हुबली", "Hubli", "Hubli"],
  belgaum: ["IXG", "Belgaum", "बेलगाव", "Belgaum", "Belgaum"],
  aurangabad: ["IXU", "Aurangabad", "औरंगाबाद", "Aurangabad", "Aurangabad"],
  shillong: ["SHL", "Shillong", "शिलांग", "Shillong", "Shillong"],
  imphal: ["IMF", "Imphal", "इम्फाल", "Imphal", "Imphal"],
  agartala: ["IXA", "Agartala", "अगरतला", "Agartala", "Agartala"],
  portblair: ["IXZ", "Port Blair", "पोर्ट ब्लेयर", "Port Blair", "Port Blair"],
  leh: ["IXL", "Leh", "लेह", "Leh", "Leh"],
  kozhikode: ["CCJ", "Kozhikode", "कोझिकोड", "Kozhikode", "Kozhikode"],
  ajmer: ["KQH", "Ajmer", "अजमेर", "Ajmer", "Ajmer"],
  jodhpur: ["JDH", "Jodhpur", "जोधपुर", "Jodhpur", "Jodhpur"],
  ujjain: ["UDR", "Ujjain", "उज्जैन", "Ujjain", "Ujjain"],
  gwalior: ["GWL", "Gwalior", "ग्वालियर", "Gwalior", "Gwalior"],
  jabalpur: ["JLR", "Jabalpur", "जबलपुर", "Jabalpur", "Jabalpur"],
  bikaner: ["BKB", "Bikaner", "बीकानेर", "Bikaner", "Bikaner"],
  jhansi: ["JHS", "Jhansi", "झांसी", "Jhansi", "Jhansi"],
  agra: ["AGR", "Agra", "आगरा", "Agra", "Agra"],
  allahabad: ["IXD", "Allahabad", "इलाहाबाद", "Allahabad", "Allahabad"],
  bareilly: ["BEG", "Bareilly", "बरेली", "Bareilly", "Bareilly"],
  gorakhpur: ["GOP", "Gorakhpur", "गोरखपुर", "Gorakhpur", "Gorakhpur"],
}
